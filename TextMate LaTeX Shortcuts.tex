...
%%%%%%%%%%%%%%%%%%%%
I find that the Eiffel theme (\texttt{View|Theme|Eiffel}) is best 
for viewing \LaTeX{} documents. 
...
\begin{tabular}{r|l|l}
	In an open \texttt{.tex} file, type \dots & to \dots      & Comments                  \\
	\hline
	\cmdkey\texttt{R}           & typeset the document            &                           \\
	\texttt{F1}                 & fold section containing cursor  & Consider installing Palua \\
	\ctlkey\optkey\cmdkey\texttt{D}&show/hide file browser        & Configure location in preferences \\
