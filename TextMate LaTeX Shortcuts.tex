...
\begin{tabular}{r|l|l|l}
	...
	\hline
	\verb!dot = "\\dot{$1}$0";!  & \texttt{dot}\ctlkey\shiftkey. & \verb!\dot{}! & Overdot \\
	\verb!sub = "_{$1}$0";!      & \texttt{sub}\ctlkey\shiftkey. & \verb!_{}!    & Subscript \\
	\verb!sup = "^{$1}$0";!      & \texttt{sup}\ctlkey\shiftkey. & \verb!^{}!    & Superscript \\
	\verb!dotsub = "\\dot{$1}_{$2}$0";! & \texttt{dotsub}\ctlkey\shiftkey. & \verb!\dot{}_{}! & Overdot with subscript \\  
	\verb!dotsup = "\\dot{$1}^{$2}$0";! & \texttt{dotsup}\ctlkey\shiftkey. & \verb!\dot{}^{}! & Overdot with superscript \\  
	\verb!dotsubsup = "\\dot{$1}_{$2}^{$3}$0";! & \texttt{dotsubsup}\ctlkey\shiftkey. & \verb!\dot{}_{}^{}! & Overdot with sub- and super-scripts  \\  
	\verb!dotsupsub = "\\dot{$1}_{$2}^{$3}$0";! & \texttt{dotsupsub}\ctlkey\shiftkey. & \verb!\dot{}_{}^{}! & Overdot with sub- and super-scripts  \\  
	\verb!mr = "\\mathrm{$1}$0";!  & \texttt{mr}\ctlkey\shiftkey.  & \verb!\mathrm{}! & Removes math typsetting\\
	\verb!deriv = "\\frac{\\mathrm{d}$1}{\\mathrm{d}$2}$0";! & \texttt{deriv}\ctlkey\shiftkey. & \verb!\frac{\mathrm{d}}{\mathrm{d}}! & Correctly-formatted derivative \\
\end{tabular}
